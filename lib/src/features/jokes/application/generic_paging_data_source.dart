...
/// Base implementation of JokeListDataSource that wires up a PagingProviderBundle
class PagingDataSource implements JokeListDataSource {
  final WidgetRef _ref;
  final PagingProviderBundle _bundle;

  PagingDataSource(this._ref, this._bundle);
