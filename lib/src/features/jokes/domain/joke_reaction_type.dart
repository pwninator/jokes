...
enum JokeReactionType {
  ...
  thumbsUp('num_thumbs_up', Icons.thumb_up, Icons.thumb_up_outlined, Colors.green),
  thumbsDown('num_thumbs_down', Icons.thumb_down, Icons.thumb_down_outlined, Colors.orange);
