...
def mock_services_fixture(monkeypatch):
  ...
  return mock_firestore, mock_joke_ops, mock_utils, mock_doc_ref
...
def test_create_book_success(mock_services, mock_get_user_id):
  ...
  # Arrange
  _, mock_joke_ops, mock_utils, mock_doc_ref = mock_services
...
def test_create_book_invalid_method(mock_services):
