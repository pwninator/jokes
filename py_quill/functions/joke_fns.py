...
def upscale_joke(req: https_fn.Request) -> https_fn.Response:
    ...
    try:
        ...
        if joke.setup_image_url:
            gcs_uri = cloud_storage.extract_gcs_uri_from_image_url(joke.setup_image_url)
        ...
        if joke.punchline_image_url:
            gcs_uri = cloud_storage.extract_gcs_uri_from_image_url(joke.punchline_image_url)
            upscaled_image = client.upscale_image(gcs_uri=gcs_uri, new_size=new_size)
