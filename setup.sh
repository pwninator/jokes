...
sudo apt-get install -y apt-transport-https wget curl git unzip jq xz-utils zip libglu1-mesa
...
echo "Installing Android platform tools..." yes | sudo "$ANDROID_HOME/cmdline-tools/latest/bin/sdkmanager" --licenses
