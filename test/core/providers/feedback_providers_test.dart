...
void main() {
  group('allFeedbackProvider', () {
    test('should emit sorted feedback entries by last user message time', () async {
      // Arrange
      ...
      when(() => mockRepository.watchAllFeedback()).thenAnswer((_) => Stream.value(unsortedEntries));
