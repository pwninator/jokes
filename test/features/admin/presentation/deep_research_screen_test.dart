...
void main() {
  ...
  Widget buildTestWidget(List<Override> overrides) {
    return ProviderScope(
      overrides: overrides,
      child: const MaterialApp(home: Scaffold(body: DeepResearchScreen())),
    );
  }
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      final overrides = [
        ...
        // Override searchResultIdsProvider for deep research scope
        searchResultIdsProvider.overrideWithProvider((scope) {
      ...
      // Verify prompt was generated by checking the presence of the Copy button
      // (only visible when composed prompt is non-empty)
