...
// in snickerdoodle/test/features/jokes/application/providers_test.dart.
...
class MockJokeRepository extends _i1.Mock implements _i2.JokeRepository {
  ...
  @override
  _i3.Stream<List<_i4.Joke>> getJokes() =>
      (super.noSuchMethod(
            Invocation.method(#getJokes, []),
            returnValue: _i3.Stream<List<_i4.Joke>>.empty(),
          )
          as _i3.Stream<List<_i4.Joke>>);
}
...
class MockJokeCloudFunctionService extends _i1.Mock
    implements _i5.JokeCloudFunctionService {
