...
// in snickerdoodle/test/features/jokes/data/repositories/joke_repository_test.dart.
...
class MockDocumentChange<T extends Object?> extends _i1.Mock
    implements _i4.DocumentChange<T> {
  MockDocumentChange() {
    _i1.throwOnMissingStub(this);
  }
  ...
  @override
  _i4.DocumentSnapshot<T> get doc =>
      (super.noSuchMethod(
            Invocation.getter(#doc),
            returnValue: _FakeDocumentSnapshot_12<T>(
              this,
              Invocation.getter(#doc),
            ),
          )
          as _i4.DocumentSnapshot<T>);
}

/// A class which mocks [QueryDocumentSnapshot].
///
/// See the documentation for Mockito's code generation for more information.
class MockMapQueryDocumentSnapshot extends _i1.Mock
    implements _i4.QueryDocumentSnapshot<Map<String, dynamic>> {
  MockMapQueryDocumentSnapshot() {
    _i1.throwOnMissingStub(this);
  }
